...
{
private:
    static const int QR_VERSION = 6;           // QR Code version (1-40)
    static const int QR_ERROR_CORRECTION = 2; // Error correction level (0-3)
    static const int QR_BUFFER_SIZE = qrcode_getBufferSize(QR_VERSION);
