...
console.log('🧪 Teste Final de Notificações Frontend');
console.log('=======================================\n');
...
async function testFrontendNotifications() {
  try {
    ...
    console.log('\n🎯 Enviando notificações de teste para o frontend...\n');
    ...
    // Enviar via evento de notificação
    socket.emit('notification', pumpNotification);
    ...
    socket.emit('notification', irrigationNotification);
    ...
    socket.emit('notification', confirmationNotification);
